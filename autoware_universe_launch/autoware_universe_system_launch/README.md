# autoware_universe_system_launch

## Structure

![autoware_universe_system_launch](./system_launch.drawio.svg)
...
```xml
  <include file="$(find-pkg-share autoware_universe_system_launch)/launch/system.launch.xml">
