# autoware_universe_localization_launch

## Structure

![autoware_universe_localization_launch](./localization_launch.drawio.svg)
...
```xml
  <include file="$(find-pkg-share autoware_universe_localization_launch)/launch/localization.launch.xml">
