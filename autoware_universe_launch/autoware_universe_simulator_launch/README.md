# autoware_universe_simulator_launch

## Structure

![autoware_universe_simulator_launch](./simulator_launch.drawio.svg)
...
```xml
  <include file="$(find-pkg-share autoware_universe_simulator_launch)/launch/simulator.launch.xml">
