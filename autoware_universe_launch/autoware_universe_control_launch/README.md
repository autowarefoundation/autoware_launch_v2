# autoware_universe_control_launch

## Structure

![autoware_universe_control_launch](./control_launch.drawio.svg)
...
```xml
<include file="$(find-pkg-share autoware_universe_control_launch)/launch/control.launch.py">
