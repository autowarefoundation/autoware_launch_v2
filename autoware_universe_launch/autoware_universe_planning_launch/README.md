# autoware_universe_planning_launch

## Structure

![autoware_universe_planning_launch](./planning_launch.drawio.svg)
...
```xml
<include file="$(find-pkg-share autoware_universe_planning_launch)/launch/planning.launch.xml">
  <!-- Parameter files -->
