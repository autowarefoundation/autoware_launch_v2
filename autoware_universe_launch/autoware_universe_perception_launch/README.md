# autoware_universe_perception_launch

## Structure

![autoware_universe_perception_launch](./perception_launch.drawio.svg)
...
```xml
  <include file="$(find-pkg-share autoware_universe_perception_launch)/launch/perception.launch.xml">
