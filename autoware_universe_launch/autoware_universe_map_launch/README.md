# autoware_universe_map_launch

## Structure

![autoware_universe_map_launch](./map_launch.drawio.svg)
...
<include file="$(find-pkg-share autoware_universe_map_launch)/launch/map.launch.py">
